...
import { ApiBearerAuth, ApiBody, ApiConflictResponse, ApiCookieAuth, ApiCreatedResponse, ApiForbiddenResponse, ApiOkResponse, ApiOperation, ApiParam, ApiTags, ApiUnauthorizedResponse } from "@nestjs/swagger";
...
export class CarteController {
  ...
  @Get('/')
  @ApiOperation({ summary: 'Lister les zones', description: 'Retourne la liste des zones avec, le cas échéant, le technicien assigné.' })
  @ApiOkResponse({ description: 'Liste des zones', type: ZoneEntity, isArray: true })
  ...
  @ApiOkResponse({ description: 'Zone mise à jour avec technicien assigné', type: ZoneEntity })
  @ApiUnauthorizedResponse({ description: 'Non authentifié' })
  @ApiForbiddenResponse({ description: 'Accès interdit' })
  ...
  @ApiConflictResponse({ description: "Impossible de supprimer la zone car des interventions y sont rattachées" })
  @ApiUnauthorizedResponse({ description: 'Non authentifié' })
  @ApiForbiddenResponse({ description: 'Accès interdit' })
